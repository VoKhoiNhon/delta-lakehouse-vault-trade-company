# Example run:
# python3 jobs/bronze/sanction/sanction_address.py
...
class Executer(BronzeExecuter):
    ...
    def transform(self):
        ...
        SELECT
            ...
            referents,
            city[0]        AS city,
            country[0]     AS country_code,
            full,
            post_office_box,
            postal_code[0] AS postal_code,
            region[0]      AS region,
            remarks,
            state[0]       AS state,
            street[0]      AS street,
            ...
            schema,
            load_date
        FROM   sanction_address
        WHERE  schema = 'Address'
        """
...
def run(payload=None):
    table_meta = TableMeta(
        from_files="metas/bronze/sanction/sanction_address.yaml", payload=payload
    )
    executer = Executer(
        app_name="bronze.sanction.address",
