...
class BridgeCompanyDemographic(SatelliteVaultExecuter):
    def transform(self):
        ...
        bridge_company_key = (
            ...
            .select(
                ...
                *[
                    ...
                    for c in s_company_demographic.columns
                ],
            )
        )
...
def run(env="pro", payload=None, spark=None):
    ...
    executer_hub = BridgeCompanyDemographic(
        sys.argv[0], table_meta_hub.model, table_meta_hub.input_resources, None, spark
    )
